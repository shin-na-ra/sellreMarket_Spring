				...
				<c:if test="${item.status == 1 }">
					...
					<!--******************************** 판매중일 때 ********************************-->
						...
						<!-- product_image -->
							...
							<div class="form-group">
								<label for="bname">제조사명 *</label>
								<input type="text" id="bname" name="bname" value="${item.bname }" readonly="readonly" style="background-color: #efefef;">
							</div>
 							<!-- brand  end-->
							...
							<div class="form-group">
								<label for="nutrition">영양성분</label>
								<input type="text" id="nutrition" name="nutrition" value="${item.nutrition }" readonly="readonly" style="background-color: #efefef;">
							</div>
							
							<div class="form-group">
								<label for="pstock">수량 *</label>
								<input type="text" id="pstock" name="pstock" value="${item.pstock }" readonly="readonly" style="background-color: #efefef;">
							</div>
							
							
							<div class="form-group">
								<label for="origin">원산지 *</label>
								<input type="text" id="origin" name="origin" value="${item.origin }" readonly="readonly" style="background-color: #efefef;">
							</div>
							
							<div class="form-group"> 
								<label for="description">설명 *</label>
								<textarea id="description" name="description" readonly="readonly" style="background-color: #efefef;">${item.description }</textarea>
							</div>
						<!-- product end-->
						...
						<!-- price -->				
							<div class="form-group">
								<label for="price">가격 *</label>
								<input type="text" id="price" name="price" value="${item.price}" readonly="readonly" style="background-color: #efefef;">
							</div>
						<!-- price -->	
						...
						<!-- category -->	
							<div class="form-group2">
								<label for="category">카테고리 대분류*</label>
								<input type="text" id="category" name="category" value="${item.type}" readonly="readonly" style="background-color: #efefef;">
							</div>
							
							<div class="form-group2">
								<label for="category">카테고리 중분류*</label>
								<input type="text" id="category1" name="category1" value="${item.subtype}" readonly="readonly" style="background-color: #efefef;">
							</div>
						<!-- category -->	
						...
						<!-- packing -->	
							<div class="form-group2">
								<label for="packtype">포장타입</label>
								<input type="text" id="packtype" name="packtype" value="${item.packtype}" readonly="readonly" style="background-color: #efefef;">
							</div>
			
							<div class="form-group2">
								<label for="packkind2">포장종류</label>
								<input type="text" id="packkind2" name="packkind2" value="${item.packkind}" readonly="readonly" style="background-color: #efefef;">
							</div>
	
						<!-- saleunit -->
							<div class="form-group">
								<label for="utype">판매단위</label>
								<input type="text" id="utype" name="utype" value="${item.utype }" readonly="readonly" style="background-color: #efefef;">
							</div>
							
							<div class="form-group">
								<label for="ugram">중량</label>
								<input type="text" id="ugram" name="ugram" value="${item.ugram }" readonly="readonly" style="background-color: #efefef;">
							</div>
						<!-- saleunit -->
						...
						<!-- delivertype -->
							<div class="form-group2">
								<label for="dname">배송종류</label	>
								<input type="text" id="dname1" name="dname1" value="${item.dname }" readonly="readonly" style="background-color: #efefef;">
							</div>
						<!-- delivertype -->
							<input type="text" id="productid" name="productid" hidden="true" value="${item.productid }">
							<input type="submit" class="deleteBtn" id="deleteBtn" onclick="changeProduct()" value="상태변경">
						</c:if>
